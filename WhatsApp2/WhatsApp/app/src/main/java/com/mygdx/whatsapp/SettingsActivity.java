    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE){
            ...
            if (resultCode == RESULT_OK) {
                ...
                loadingBar.setMessage("Please wait while your profile image updating");
                ...
                filePath.putFile(resultUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        if(task.isSuccessful()){
                            Toast.makeText(SettingsActivity.this, "Profile Image Uploaded succcessfully", Toast.LENGTH_SHORT).show();
                                 ...
                                 UserProfileImagesRef.child(currentUserID + ".jpg").getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                                    ...
                                    RootRef.child("Users").child(currentUserID).child("image")
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if(task.isSuccessful()){
                                                        Toast.makeText(SettingsActivity.this, "Image save in Database, successfullt", Toast.LENGTH_SHORT).show();
                                                        loadingBar.dismiss();
                                                    }
                                                    else{
                                                        String message = task.getException().toString();
