...
public class AdapterGroupChatList extends RecyclerView.Adapter<AdapterGroupChatList.HolderGroupChatList> {
    ...
    public void onBindViewHolder(@NonNull HolderGroupChatList holder, int position) {
        ...
        try{
            Picasso.get().load(groupIcon).placeholder(R.drawable.ic_group_primary_foreground).into(holder.groupIconIv);  //gali blogai but
        }
        catch (Exception e){
            holder.groupIconIv.setImageResource(R.drawable.ic_group_primary_foreground);
        }
